...
@dataclass
class WorldInfo:
    limit_x: list = field(default_factory=lambda: [0, 1920])  # [min, max] x coordinate [meter] 设置了默认值[0, 100]
    limit_y: list = field(default_factory=lambda: [0, 1080])  # [min, max] y coordinate [meter]
