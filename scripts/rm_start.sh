...
export ROS_HOME="/home/jlcv/yjq/sentry"
cd /home/jlcv/yjq/sentry
# 设置需要启动和监视的ros命令
declare -a commands=("ros2 launch velodyne velodyne-all-nodes-VLP16-launch.py "
	"ros2 launch rm_imu imu_driver.launch.py"
